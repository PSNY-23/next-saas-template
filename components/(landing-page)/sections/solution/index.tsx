    ...
    <section>
      <div className="2xl:py-20 py-11">
        <div>
          <div
            ref={ref}
            className="py-12 md:py-28 px-4 md:px-6 outline-2 outline-offset-2 rounded-3xl bg-[linear-gradient(90deg,#CDEFFB_0%,#FFFFFF_33.23%,#FFFFFF_65.77%,#FDEECB_100%)] dark:opacity-50 backdrop-blur-[200px]"
          >
            <motion.div
              {...bottomAnimation}
