...
const {onlinePresenceList} = pageData;
        ...
        <div className='container'>
          <div className='flex flex-col justify-center items-center gap-10 md:gap-20'>
            <div className='max-w-2xl text-center'>
              <h2>
                <TextGenerateEffect words="How we transformed a small business’s" duration={0.5} className='text-5xl'/>
                <TextGenerateEffect
            ...
            <div className='grid md:grid-cols-2 gap-x-6 gap-y-8 w-full'>
              {onlinePresenceList?.map((items, index: number) => (
                <motion.div
                  key={index}
